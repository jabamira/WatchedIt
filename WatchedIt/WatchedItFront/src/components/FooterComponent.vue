<template>
  <footer
    class="shadow-sm dark:border-slate-700 dark:bg-gray-800 bg-white border-gray-200 border"
  >
    <div class="w-full max-w-screen-xl mx-auto p-2 md:py-4">
      <div class="sm:flex sm:items-center sm:justify-between">
        ...
        <ul
          class="flex flex-wrap items-center mb-2 text-xs font-medium text-gray-500 sm:mb-0 dark:text-gray-400"
        >
          <li>
      ...
      <span
        class="block text-xs text-gray-500 sm:text-center dark:text-gray-400"
      >
        © 2023 <a href="" class="hover:underline">WathedIt™</a>. All Rights
        Reserved.
      </span>
    </div>
  </footer>
