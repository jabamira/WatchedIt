<template>
  <nav
    class="bg-white border-gray-200 dark:bg-gray-800 fixed flex flex-row top-0 left-0 w-full z-50"
  >
    <!--logo для больших-->
    <a
    ...
    <div class="flex flex-wrap items-center justify-between mx-auto p-4 w-full">
      <div class="flex flex-row items-center md:order-2 space-x-5 md:space-x-3">
        <div class="flex-row gap-10 hidden md:flex md:order-3">
      ...
      <div class="flex flex-row gap-3 md:order-2">
        <!--кнопки логина-->
        <div v-if="!IsAuth" class="flex flex-row gap-3 md:order-2">
          <a href="http://localhost:5173/#/InfoPage" class="btn-indigo-light"
            >Login</a
          >
          <a
        ...
        <!--кнопки профиля-->
        <div v-else class="flex flex-row gap-3 items-center mr-25 md:order-2">
