<template>
  <nav
    class="bg-white border-gray-200 dark:bg-slate-700 fixed top-0 left-0 w-full z-50"
  >
    <div class="flex flex-wrap items-center justify-between mx-auto p-4 w-full">
      ...
      <div
        v-if="!IsAuth"
        class="flex items-center md:order-2 space-x-2 md:space-x-2 rtl:space-x-reverse"
      >
        <a href="http://localhost:5173/#/Auth" class="btn-indigo-light"
          >Login</a
        >
        <a
        ...
        <button
          ...
          type="button"
          class="inline-flex items-center p-2 w-10 h-10 justify-center dark:bg-gray-800 bg-gray-500 text-sm rounded-lg md:hidden focus:outline-none focus:ring-2"
      ...
      <div id="mega-menu" class="hidden w-full md:flex md:w-auto md:order-1">
        <ul
          class="flex flex-col md:flex-row mt-4 font-medium md:mt-0 md:justify-between md:gap-4 rtl:space-x-reverse w-full"
        >
          <li>
            <button
            ...
            <div
              ...
              class="absolute z-10 hidden grid w-auto grid-cols-1 text-sm dark:bg-gray-800 rounded-lg border border-gray-500"
            >
              <div class="p-4 pb-0">
                <ul
                  class="space-y-4"
